...
export const translations: Record<'en' | 'es', TranslationStrings> = {
  en: {
    ...
    editDilemma: 'Edit Input',
    undoSelection: 'Change Selection',
    resetWeights: 'Reset Adjustments',
    ...
    breakTheTie: 'Analyze & Break the Tie',
    analyzing: 'Evaluating Decisions & Trade-offs',
    analyzingSub: 'Applying structured frameworks to provide objective clarity.',
    analyzingSteps: [
      'Deconstructing trade-offs and options...',
      'Calculating weighted impacts & downsides...',
      'Synthesizing comparison matrix & SWOT factors...',
      'Formulating the Tiebreaker verdict & crux question...',
    ],
    tryExample: 'Or start with a curated dilemma:',
    tabs: {
    ...
    riskHedging: 'Downside Risk Hedging',
    immediateSteps: 'Action Steps (Next 48 Hours)',
    flipCoinPrompt: 'Still wrestling with ambiguity? Run the subconscious coin test:',
    flipCoinButton: 'Flip Decision Coin',
    ...
    customItemPlaceholder: 'Add your own factor and press Enter...',
    ...
    selectWinnerPrompt: 'Which path will you take?',
    followUpQuestionPlaceholder: 'Ask a specific follow-up doubt or test a what-if scenario...',
  ...
  es: {
    ...
    editDilemma: 'Editar Entrada',
    undoSelection: 'Cambiar Elección',
    resetWeights: 'Restablecer Ajustes',
    ...
    breakTheTie: 'Analizar y Romper el Empate',
    analyzing: 'Evaluando Opciones y Trade-offs',
    analyzingSub: 'Aplicando marcos estratégicos para brindarte máxima claridad objetiva.',
    analyzingSteps: [
      'Desglosando trade-offs y opciones clave...',
      'Calculando impactos ponderados y riesgos...',
      'Construyendo matriz comparativa y factores DAFO...',
      'Formulando el veredicto de desempate y la pregunta clave...',
    ],
    tryExample: 'O comienza con un dilema curado:',
    tabs: {
    ...
    riskHedging: 'Mitigación de Riesgos',
    immediateSteps: 'Acciones para las Próximas 48 Horas',
    flipCoinPrompt: '¿Persiste la duda? Aplica la prueba del subconsciente con la moneda:',
    flipCoinButton: 'Lanzar Moneda de Decisión',
    ...
    customItemPlaceholder: 'Añade tu propio factor y pulsa Enter...',
    ...
    selectWinnerPrompt: '¿Qué camino vas a tomar?',
    followUpQuestionPlaceholder: 'Pregunta una duda puntual o pon a prueba un escenario hipotético...',
